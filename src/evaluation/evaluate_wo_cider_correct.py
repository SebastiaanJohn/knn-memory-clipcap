        ...
        for scorer, method in self.scorers:
            ...
            for vid_id in gt_vid_ids:
                ...
                if scorer.method() == 'Bleu':
                    score_blue1.append((num_frames_vid, score[0]))
                    score_blue2.append((num_frames_vid, score[1]))
                    score_blue3.append((num_frames_vid, score[2]))
                    score_blue4.append((num_frames_vid, score[3]))

                else:
                    scores_len.append((num_frames_vid, score))
...
if __name__=='__main__':
    ...
    parser.add_argument('-s', '--submission', type=str,  default='data/no_memory_captions_first.json',
    ...
    parser.add_argument('-r', '--references', type=str, default='data/no_memory_references_first.json',
                        help='reference files with ground truth captions to compare results against. delimited (,) str')
