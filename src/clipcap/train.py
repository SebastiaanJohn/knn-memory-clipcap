...
class MappingType(Enum):
    """Type of mapping from CLIP embedding to GPT2 prefix."""
...
class MLP(nn.Module):
    ...
    def __init__(self, sizes: tuple[int, ...], bias: bool = True, act=nn.Tanh):
        ...
        Args:
            ...
            act (optional): The activation function to use. Defaults to
                nn.Tanh.
        """
...
class MlpTransformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            out_d (int | None, optional): The output dimension. Defaults to
                None.
            act (_type_, optional): The activation function to use. Defaults
                to nnf.relu.
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            y (torch.Tensor | None, optional): The reference tensor. Defaults
                to None.
            mask (torch.Tensor | None, optional): The mask tensor. Defaults to
                None.
...
class TransformerLayer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            dim_ref (int): The dimension of the reference.
            num_heads (int): The number of heads.
            mlp_ratio (float, optional): The ratio of the MLP hidden dimension
                to the input dimension. Defaults to 4.0.
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            dim_ref (int | None, optional): The dimension of the reference.
                Defaults to None.
            mlp_ratio (float, optional): The ratio of the MLP hidden dimension
                to the input dimension.
            act (_type_, optional): The activation function to use.
            norm_layer (_type_, optional): The normalization layer to use.
            enc_dec (bool, optional): Whether to use encoder-decoder
    ...
    def forward_with_attention(
        ...
        Returns:
            tuple[torch.Tensor, list[torch.Tensor]]: The output and the
                attention.
        """
        attentions = []
